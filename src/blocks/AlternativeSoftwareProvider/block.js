/**
 * BLOCK: AlternativeSoftwarteProviders
 *
 */
...
registerBlockType( 'wpvcb/alternative-software-provider', { 
	title: __( 'Alternative Software Providers', 'wpvcb-blocks' ), 
	icon: 'yes-alt', 
	category: 'wpvcb', 
	attributes: {
		post_id: {
	...
	edit: ( props ) => {
		...
		return (
			<Fragment>
				<Placeholder 
					icon= 'yes-alt'
					label={ __( 'Alternative Software Providers', 'wpvcb-blocks' ) }
					className="wpvcb-block wpvcb-block-alternative-software-provider"
				>
					<div className="wpvcb-block__selection wpvcb-block-alternative-software-provider__selection" onClick={ addExclude }>
						<TextControl
							type="hidden"
							value={ post_id }
						/>
						...
						<ToggleControl
							label={ __(
								'Display selected software provider only',
								'wpvcb-blocks'
							) }
						...
						<ToggleControl
							label={ __(
								'Show software with 0 partners',
								'wpvcb-blocks'
							) }
							checked={ enable_software_zero_partners }
							onChange={ ( value ) =>
								setAttributes( { enable_software_zero_partners: value } )
							}
						/>
					</div>
				</Placeholder>
