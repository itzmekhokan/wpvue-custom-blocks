 ...
 */
registerBlockType( 'wpvcb/right-content-simpletoc', { 
	title: __( 'Right side content of SimpleTOC', 'wpvcb-blocks' ), 
	icon: simpletocicon, 
	category: 'wpvcb', 
	attributes: {
		content: {
	...
	edit: ( props ) => {
		...
		return (
			<Fragment>
				<Placeholder 
					icon= { simpletocicon }
					label={ __( 'Right side content of SimpleTOC', 'wpvcb-blocks' ) }
					instructions={ __( 'This block is will append right side of SimpleTOC.', 'wpvcb-blocks' ) }
					className="wpvcb-block wpvcb-block-right-content-simpletoc"
				>
					<div className="wpvcb-block__selection wpvcb-block-right-content-simpletoc__selection">
